...
const NavBar = () => {
    ...
    return (
        <div className='flex items-start justify-between z-4 fixed w-full'>
            ...
            <div onClick={()=>{
                ...
                navGreenraf.current.style.cursor = 'pointer'
            }}
                onMouseLeave={() => {
                    navGreenraf.current.style.height = '0%'
                }}
                className='relative bg-black z-5 w-50 lg:h-14 h-12'>
                <div className='relative  left-25 lg:top-6 top-3 h-10 w-16'>
                    <div className='flex flex-col items-end lg:gap-1 gap-2' >
                        <div className='bg-white lg:w-13 w-15 h-0.5 r-10 top-3 ' ></div>
                        <div className='bg-white lg:w-1/2 w-12 h-0.5 r-10 top-3 ' ></div>
                    </div>
                </div>
                <div ref={navGreenraf} className='absolute top-0 bg-[#F0FF7C] h-0 w-full transition-all'>
