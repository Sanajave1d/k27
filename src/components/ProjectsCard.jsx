    ...
    return (
        <>
            <div
                ...
                className='lg:w-1/2 lg:h-full relative project rounded-none hover:cursor-pointer hover:rounded-[50px] duration-500 transition-all ease-linear overflow-hidden w-full h-[32vh] bg-green-300' >
            ...
            <div onMouseEnter={handleMouseEnter}
                onMouseLeave={handleMouseLeave}
                className='lg:h-full lg:w-1/2 relative project rounded-none hover:cursor-pointer hover:rounded-[50px] duration-500 transition-all ease-linear overflow-hidden w-full h-[32vh] bg-green-300' >
